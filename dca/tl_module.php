...
(
	'label'                   => &$GLOBALS['TL_LANG']['tl_module']['mooquee4wardDuration'],
	'exclude'                 => true,
	'inputType'               => 'text',
	'default'				  => '1000',
	'eval'                    => array('mandatory'=>true, 'rgxp'=>'digit','tl_class'=>'w50')
);
$GLOBALS['TL_DCA']['tl_module']['fields']['mooquee4wardPause'] = array
(
	'label'                   => &$GLOBALS['TL_LANG']['tl_module']['mooquee4wardPause'],
	'exclude'                 => true,
	'inputType'               => 'text',
	'default'				  => '1500',
	'eval'                    => array('mandatory'=>true,'tl_class'=>'w50','rgxp'=>'digit')
);
$GLOBALS['TL_DCA']['tl_module']['fields']['mooquee4wardSize'] = array
(
...
(
	'label'                   => &$GLOBALS['TL_LANG']['tl_module']['mooquee4wardTransin'],
	'exclude'                 => true,
	'inputType'               => 'select',
	'default'				  => 'left',
	'options'				  => array('left'=>'left','right'=>'right','up'=>'up','down'=>'down','fade'=>'fade','none'=>'none'),
	'reference'				  => &$GLOBALS['TL_LANG']['tl_module']['mooquee4wardTransitions'],
	'eval'                    => array('mandatory'=>true,'tl_class'=>'w50')
);
$GLOBALS['TL_DCA']['tl_module']['fields']['mooquee4wardTransout'] = array
(
	'label'                   => &$GLOBALS['TL_LANG']['tl_module']['mooquee4wardTransout'],
	'exclude'                 => true,
	'inputType'               => 'select',
	'default'				  => 'fade',
	'options'				  => array('left'=>'left','right'=>'right','up'=>'up','down'=>'down','fade'=>'fade','none'=>'none'),
...
$GLOBALS['TL_DCA']['tl_module']['fields']['mooquee4wardTransition1'] = array
(
	'label'                   => &$GLOBALS['TL_LANG']['tl_module']['mooquee4wardTransition1'],
	'exclude'                 => true,
	'inputType'               => 'select',
	'default'				  => 'quad',
...
$GLOBALS['TL_DCA']['tl_module']['fields']['mooquee4wardTransition2'] = array
(
	'label'                   => &$GLOBALS['TL_LANG']['tl_module']['mooquee4wardTransition2'],
	'exclude'                 => true,
	'inputType'               => 'radio',
	'default'				  => 'inOut',
...
$GLOBALS['TL_DCA']['tl_module']['fields']['mooquee4wardFirstitem'] = array
(
...
(
	'label'                   => &$GLOBALS['TL_LANG']['tl_module']['mooquee4wardPauseOnHover'],
	'exclude'                 => true,
	'inputType'               => 'checkbox',
	'default'				  => '1',
	'eval'                    => array('mandatory'=>false,'tl_class'=>'w50')
);
$GLOBALS['TL_DCA']['tl_module']['fields']['mooquee4wardShowNav'] = array
(
	'label'                   => &$GLOBALS['TL_LANG']['tl_module']['mooquee4wardShowNav'],
	'exclude'                 => true,
	'inputType'               => 'checkbox',
	'default'				  => '1',
	'eval'                    => array('mandatory'=>false,'tl_class'=>'w50')
